...
class Absence {
    ...
    public static function getByEtudiantId($etudiant_id) {
        $query = "SELECT a.id, a.etudiant_id, a.cours_id, a.date_absence, a.statut, 
                         u.nom, c.nom as cours_nom 
                  FROM absences a
    ...
    public static function create($etudiant_id, $cours_id, $date_absence, $statut = 'absent') {
