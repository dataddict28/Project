...
<div class="card">
    <div class="card-header">
        <h4 class="mb-0">
            <i class="bi bi-list-check me-2"></i>Inscriptions
        </h4>
    </div>
    <div class="card-body">
        <?php if (empty($inscriptions)): ?>
            <div class="alert alert-info">
                <i class="bi bi-info-circle me-2"></i>Aucune inscription enregistrée.
            </div>
        <?php else: ?>
                    ...
                    <tbody>
                        <?php foreach ($inscriptions as $insc): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?page=inscriptions&delete=<?php echo $insc['id']; ?>" 
